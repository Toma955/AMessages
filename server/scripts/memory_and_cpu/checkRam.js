...
module.exports = async function checkRam(locale) {
  ...
  // Provjeri je li u JSON-u ključ "folderSizeMessage" ispravan (ako nije, promijeni na "diskSpaceMessage" ili slično)
  if (!locale.disk.folderSizeMessage) {
    locale.disk.folderSizeMessage = "Veličina foldera: {{size}} MB";
  }
  console.log(locale.disk.folderSizeMessage.replace("{{size}}", folderSizeMB.toFixed(2)));
