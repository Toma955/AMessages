      ...
      function registerProcessors() {
        client.on('spanStart', span => {
          ...
          if (name === 'ai.generateText') {
            span.setAttribute(core.SEMANTIC_ATTRIBUTE_SENTRY_OP, 'gen_ai.invoke_agent');
            return;
          }
        ...
        client.addEventProcessor(event => {
          if (event.type === 'transaction' && event.spans?.length) {
            for (const span of event.spans) {
              ...
              renameAttributeKey(
                attributes,
                ai_sdk_attributes.AI_USAGE_COMPLETION_TOKENS_ATTRIBUTE,
                ai_sdk_attributes.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE,
              );
              renameAttributeKey(attributes, ai_sdk_attributes.AI_USAGE_PROMPT_TOKENS_ATTRIBUTE, ai_sdk_attributes.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE);
              if (
              ...
              renameAttributeKey(attributes, ai_sdk_attributes.AI_PROMPT_MESSAGES_ATTRIBUTE, 'gen_ai.request.messages');
              renameAttributeKey(attributes, ai_sdk_attributes.AI_RESPONSE_TEXT_ATTRIBUTE, 'gen_ai.response.text');
              renameAttributeKey(attributes, ai_sdk_attributes.AI_RESPONSE_TOOL_CALLS_ATTRIBUTE, 'gen_ai.response.tool_calls');
              renameAttributeKey(attributes, ai_sdk_attributes.AI_PROMPT_TOOLS_ATTRIBUTE, 'gen_ai.request.available_tools');
            }
          }
